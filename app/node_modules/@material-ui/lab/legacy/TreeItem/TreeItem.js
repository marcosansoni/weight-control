...
import { alpha, experimentalStyled, unstable_useThemeProps as useThemeProps } from '@material-ui/core/styles';
...
var TreeItemRoot = experimentalStyled('li', {}, {
  name: 'MuiTreeItem',
  slot: 'Root',
...
var StyledTreeItemContent = experimentalStyled(TreeItemContent, {}, {
  name: 'MuiTreeItem',
  slot: 'Content',
  overridesResolver: function overridesResolver(props, styles) {
    return _extends({}, styles.content, styles.iconContainer && _defineProperty({}, "& .".concat(treeItemClasses.iconContainer), styles.iconContainer), styles.label && _defineProperty({}, "& .".concat(treeItemClasses.label), styles.label));
  }
})(function (_ref3) {
  var _ref4;
...
var TreeItemGroup = experimentalStyled(Collapse, {}, {
  name: 'MuiTreeItem',
  slot: 'Group',
  overridesResolver: function overridesResolver(props, styles) {
    return styles.group;
