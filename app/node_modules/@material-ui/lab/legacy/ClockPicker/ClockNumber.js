...
function ClockNumber(props) {
  var className = props.className,
      ...
      other = _objectWithoutProperties(props, ["className", "disabled", "index", "inner", "label", "selected"]); // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
