...
function getMonthPickerUtilityClass(slot) {
  return (0, _unstyled.generateUtilityClass)('MuiMonthPicker', slot);
}

const monthPickerClasses = (0, _unstyled.generateUtilityClasses)('MuiMonthPicker', ['root']);
...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)(slots, getMonthPickerUtilityClass, classes);
};

const MonthPickerRoot = (0, _styles.experimentalStyled)('div', {}, {
  name: 'MuiMonthPicker',
  slot: 'Root',
...
const MonthPicker = /*#__PURE__*/React.forwardRef(function MonthPicker(inProps, ref) {
  ...
  const {
    ...
    onMonthChange
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "date", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "onMonthChange"]); // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
