...
const PickersYearRoot = (0, _styles.experimentalStyled)('div', {}, {
  skipSx: true
})(({
  styleProps
}) => (0, _extends2.default)({
...
}, (styleProps === null || styleProps === void 0 ? void 0 : styleProps.wrapperVariant) === 'desktop' && {
  flexBasis: '25%'
}));
const PickersYearButton = (0, _styles.experimentalStyled)('button', {}, {
  skipSx: true
})(({
  theme
}) => (0, _extends2.default)({
