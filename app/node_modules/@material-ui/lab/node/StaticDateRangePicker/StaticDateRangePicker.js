...
const StaticDateRangePicker = /*#__PURE__*/React.forwardRef(function StaticDateRangePicker(inProps, ref) {
  ...
  const {
    ...
    maxDate: maxDateProp = _propTypes2.defaultMaxDate
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["calendars", "displayStaticWrapperAs", "value", "onChange", "mask", "startText", "endText", "inputFormat", "minDate", "maxDate"]);
