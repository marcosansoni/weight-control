...
const MonthPicker = /*#__PURE__*/React.forwardRef(function MonthPicker(inProps, ref) {
  ...
  const {
    ...
    onMonthChange
        ...
        other = _objectWithoutPropertiesLoose(props, ["className", "date", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "onMonthChange"]); // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
