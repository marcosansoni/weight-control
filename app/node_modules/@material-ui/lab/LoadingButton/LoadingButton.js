...
const LoadingButton = /*#__PURE__*/React.forwardRef(function LoadingButton(props, ref) {
  const {
    ...
    loadingPosition = 'center'
        ...
        other = _objectWithoutPropertiesLoose(props, ["children", "classes", "className", "disabled", "loading", "loadingIndicator", "loadingPosition"]);
  ...
  return /*#__PURE__*/_jsxs(Button, _extends({
    ...
    children: [loading && /*#__PURE__*/_jsx("div", {
      className: clsx(classes.loadingIndicator, classes[`loadingIndicator${capitalize(loadingPosition)}`]),
