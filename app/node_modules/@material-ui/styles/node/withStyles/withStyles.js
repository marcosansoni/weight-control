...
const withStyles = (stylesOrCreator, options = {}) => Component => {
  const {
    ...
    name
        ...
        stylesOptions = (0, _objectWithoutPropertiesLoose2.default)(options, ["defaultTheme", "withTheme", "name"]);
  ...
  const WithStyles = /*#__PURE__*/React.forwardRef(function WithStyles(props, ref) {
    const other = (0, _objectWithoutPropertiesLoose2.default)(props, ["classes"]); // The wrapper receives only user supplied props, which could be a subset of
